...
const ImprovedLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      notificationService.showSuccess('Welcome back! Redirecting to your dashboard...');
  ...
  const handleForgotPassword = () => {
    if (formData.email) {
      notificationService.showInfo('Password reset functionality coming soon!');
    } else {
      notificationService.showError('Please enter your email address first');
    }
  };
