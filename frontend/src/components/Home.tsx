        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-xl lg:text-2xl text-gray-400 leading-relaxed max-w-2xl">
                {isAuthenticated ? (
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                {!isAuthenticated && (
                  <Link 
                    to="/login" 
                    className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-blue-500 bg-gray-800 rounded-xl hover:bg-gray-700 transition-all duration-200 shadow-lg hover:shadow-xl border border-gray-600"
                  >
                    Sign In
                  </Link>
                )}
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 bg-gray-800 rounded-3xl border border-gray-700 p-6 sm:p-8">
                <div className="relative w-full h-full">
                  {/* House */}
                  <div className="absolute bottom-8 left-8 w-16 h-20 bg-gray-600 rounded-lg">
                    <div className="absolute -top-2 left-0 w-0 h-0 border-l-8 border-r-8 border-b-4 border-l-transparent border-r-transparent border-b-gray-600"></div>
                    <div className="absolute bottom-2 left-2 w-4 h-6 bg-gray-500 rounded"></div>
                    <div className="absolute top-4 right-2 w-3 h-3 bg-gray-500 rounded"></div>
                  </div>
                  {/* Car */}
                  <div className="absolute bottom-4 right-8 w-12 h-6 bg-gray-600 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-white">For Owners</h3>
                <p className="text-gray-400 leading-relaxed">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-white">Secure & Easy</h3>
                <p className="text-gray-400 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="bg-gray-800 rounded-xl p-6 sm:p-8 shadow-md hover:shadow-lg transition-shadow duration-200 border border-gray-600">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Easy Search</h3>
              <p className="text-gray-400 leading-relaxed">
                Find driveways by location, price, and car size compatibility with our advanced search.
              </p>
            </div>
            
            <div className="bg-gray-800 rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow duration-200 border border-gray-600">
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-black">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/register" 
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-white bg-blue-500 rounded-xl hover:bg-blue-600 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Create Account
              </Link>
              <Link 
                to="/login" 
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-white border-2 border-gray-600 rounded-xl hover:bg-gray-800 transition-all duration-200"
              >
                Sign In
              </Link>
            </div>
